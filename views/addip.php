...
<?php
$ipaddradd=$_POST["ipaddradd"];
?> 

      <div class="jumbotron">
        <h1>IP <?php echo $ipaddradd; ?> added</h1>
</div>

<?php
$con=mysqli_connect("localhost","root","JgoETevM","login");
// Check connection
if (mysqli_connect_errno() OR empty($ipaddradd))
  {
  echo "No IP addresses entered";
  }
else
{
  $ipaddradd=$_POST["ipaddradd"];
mysqli_query($con,"INSERT INTO `login`.`ipaddr` (
`id` ,
`ipaddr`
)
VALUES (
